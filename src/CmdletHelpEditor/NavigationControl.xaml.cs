...
namespace CmdletHelpEditor
{
	...
	public partial class NavigationControl : UserControl
	{
        ...
        public void ExportXml_Click(object sender, RoutedEventArgs e)
        {
            ...
            try
            {
                if (this.NavigationControl1.CmdletTreeView.Items.Count > 0)
                {
                    //Check where the selection is made and find the parent cmdlet name.
                    if (this.NavigationControl1.CmdletTreeView.SelectedValue != null)
                    {
                        TreeViewItem SelectedNode = (TreeViewItem)this.NavigationControl1.CmdletTreeView.SelectedItem;
                        String SelectedValue = (String)SelectedNode.Header;
                        switch (SelectedValue)
                ...
                if (CmdletHelp.CmdletName != null)
                {
                    ...
                    try
                    {
                        ...
                        List<SnapinView> SelectedSnapin = new List<SnapinView>();
                        ...
                        Nullable<System.Windows.Forms.DialogResult> result = dlg.ShowDialog();
                    ...
                    {
                        System.Windows.Forms.MessageBox.Show(ex.Message, "Error loading the help file.", System.Windows.Forms.MessageBoxButtons.OK, System.Windows.Forms.MessageBoxIcon.Warning);
                    }
                    ...
                    if (MainWindow.OldHelpFileExist)
                    {
                        ...
                        writer.Flush();
                        writer.Close();
                        System.Windows.Forms.MessageBox.Show(MainWindow.HelpFilePath + "\n\nFile saved.", "File saved", System.Windows.Forms.MessageBoxButtons.OK, System.Windows.Forms.MessageBoxIcon.Information);

                    }
                }
                else
                {
                    System.Windows.Forms.MessageBox.Show("Cannot save contents of the selected node.\nNo file has been saved.", "No file has been saved.", System.Windows.Forms.MessageBoxButtons.OK, System.Windows.Forms.MessageBoxIcon.Warning);
                }
            }
            catch (Exception ex)
            {
        ...
        public void ExportTextFile_Click(object sender, RoutedEventArgs e)
        {
            ...
            try
            {
                ...
                {
                    System.Windows.Forms.MessageBox.Show("No valid cmdlet name has been selected.\nPlease select the correct Cmdlet name.", "Not a valid selection.", System.Windows.Forms.MessageBoxButtons.OK, System.Windows.Forms.MessageBoxIcon.Warning);
                }
