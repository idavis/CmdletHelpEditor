...
namespace CmdletHelpEditor
{
    ...
    public partial class HeaderControl : UserControl
    {
        ...
        public void ForwardNavigationButton_Click( object sender, RoutedEventArgs e )
        {
            DialogResult result =
                    MessageBox.Show(
                            "All unsaved help text will be lost!\nSave help file before returning to PsSnapin page?",
                            "All unsaved help text will be lost!",
        ...
        public void SaveHelpFile( String FilePath )
        {
            ...
            if ( MainWindow.ObsoleteInfo )
            {
                MessageBoxResult Result =
                        System.Windows.MessageBox.Show(
                                "This action will make you loose all Obsolete Help info Marked in Bold red in the Tree View. Are you sure you want to proceed?",
                                "Warning!",
            ...
            if ( save )
            {
                ...
                {
                    MessageBox.Show( ex.Message, "Failed to save the help file" );
                }
            }
        }
        ...
        {
            if ( MainWindow.MainGrid1.PsSnapinList.SelectedItems.Count > 0 &&
                 MainWindow.MainGrid1.PsSnapinList.Items.Count > 0 )
            {
                try
                {
                    ...
                    {
                        DialogResult result =
                                MessageBox.Show( "This action deletes unsaved help file text.\n\nContinue?",
                                                 "Open Help File",
                                                 MessageBoxButtons.YesNo,
                                                 MessageBoxIcon.Warning );
                        ...
                        if ( result == DialogResult.Yes )
                        {
                            ...
                            DialogResult? FODresult = dlg.ShowDialog();
        ...
        public void saveHelpInfoToTextFile_Click( object sender, RoutedEventArgs args )
        {
            ...
            {
                MessageBox.Show( "Cannot save the help file because a snapin is not loaded.",
                                 "Application Error",
                                 MessageBoxButtons.OK,
                                 MessageBoxIcon.Warning );
            }
        ...
        /// <param name="sender"> </param>
        /// <param name="e"> </param>
        public void SaveHelpFileAs_Click( object sender, RoutedEventArgs e )
        {
            if ( MainWindow.CmdletsHelps.Count > 0 )
            {
                try
            ...
            {
                MessageBox.Show( "Select a PsSnapin before opening a help file.",
                                 "PsSnapin Not Selected",
                                 MessageBoxButtons.OK,
                                 MessageBoxIcon.Warning );
            }
        ...
        public void HelpLink_Click( object sender, RoutedEventArgs e )
        {
            ...
            {
                System.Windows.MessageBox.Show(
                        "Failed to load the help file. Please reinstall this aplication.\n" + ex.Message,
                        "Failed to load the help contents",
                        MessageBoxButton.OK,
        ...
        private void LoadPsNapinWithoutHelpFile( object sender, RoutedEventArgs e )
        {
            ...
            {
                DialogResult result =
                        MessageBox.Show( "When you load a snap-in, you lose any unsaved help file text.\n\nContinue?",
                                         "Select New PsSnapin",
                                         MessageBoxButtons.YesNo,
                                         MessageBoxIcon.Warning );
                if ( result == DialogResult.Yes )
